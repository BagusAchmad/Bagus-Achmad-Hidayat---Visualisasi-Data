...
st.caption("Bagian 1: Pie & Area Chart")
st.write("Kelompok 16")
st.subheader("Praktikum 8 - Anggota Kelompok:")
st.markdown("""
...
# Basic Pie Chart dan Area Chart
...
# Kustomisasi Pie Chart dan Area Chart
...
# Multiple Pie Chart dan Area Chart
else:
